...
if($Survey->create()){
  ...
  foreach($Questions as $QuestionObj){
    ...
    if($Question->create()){
      ...
      echo json_encode(array("message" => "Unable to create question.", "Question"=>$Question));
    }
  }
